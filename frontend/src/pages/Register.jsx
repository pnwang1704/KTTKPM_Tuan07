  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      >
        ...
        <h2 className="text-3xl font-bold text-center mb-2 glow-text">Join CineVerse</h2>
        <p className="text-center text-gray-400 mb-8">Create an account to book tickets</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <motion.button
            ...
            type="submit"
            disabled={loading}
            className="w-full py-3 mt-2 bg-accent-gold text-primary font-bold rounded-lg hover:bg-yellow-500 transition-colors shadow-[0_0_15px_rgba(212,175,55,0.4)] disabled:opacity-70 flex justify-center items-center h-[52px]"
          >
            {loading ? (
        ...
        <p className="text-center mt-6 text-sm text-gray-400">
          Already have an account? <Link to="/login" className="text-accent-blue hover:text-blue-400">Sign in</Link>
        </p>
      </motion.div>
    </div>
  );
